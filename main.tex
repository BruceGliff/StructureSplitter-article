...
%%----------------------------------------------------------------------------------%%
\begin{abstract}
В этой статье рассматривается алгоритм разбиения структур для векторного оптимизатора графического компилятора Intel. Приводится подробное описание алгоритма и замеры производительности.
